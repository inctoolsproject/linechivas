...
kk = LineAlpha.LINE()
kk.login(token='EjNcGBqrtfxCyTFd9Yc7.IVcbyrZtrKAGR+0kE2DCfW.RF+bL0Vsi7PzM0jMDsZ1NEwIPTQvQ0Eix4CqXMkkP6o=')
kk.loginResult()

ki = LineAlpha.LINE()
ki.login(token='EjCydpFqNcB7Dut5zosd.pnbchlHb+jQbIS3hK1irFq.r3kfKYkMrIeFJn70u7zVgMF9ECoHJvzEmdKRmL51PRg=')
ki.loginResult()
